/**
 * A candidate implementation for the Fraction interface. Sadly this contains
 * errors.
 * 
 * @author gosnat
...
public class CandidateFraction implements Fraction {
	...
	public Fraction add(Fraction other) throws ArithmeticException {
		...
		if (tempDen > Integer.MAX_VALUE || tempDen < Integer.MIN_VALUE) {
			throw new ArithmeticException("Denominator Overflow");
		}
		if (tempNum1 + tempNum2 > Integer.MAX_VALUE || tempNum1 + tempNum2 < Integer.MIN_VALUE) {
